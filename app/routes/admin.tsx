import { LoaderFunction, ActionFunction, useActionData, redirect } from 'remix';
...
export default function Admin() {
	...
	return (
		<PaneContainer>
			<PaneHeader>
				<MenuLink />
				<div className="flex-1 leading-8 line-clamp-1">Backup Resources</div>
			</PaneHeader>
			<PaneContent>
				<section className="flex flex-1 px-2.5 pt-2">
