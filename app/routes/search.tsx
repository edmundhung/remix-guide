...
export default function Index() {
  ...
  return (
    <section>
      <div className="sticky top-0 leading-8 backdrop-blur z-20 px-8 py-4 mb-8 border-b border-b-gray-600 text-sm">
      ...
      <div className="grid grid-cols-masonry pl-px pt-px">
        {entries.map((entry) => (
          <Card
            key={entry.slug}
            className="hover:border-black hover:border-gray-200 hover:text-gray-400 z-0 hover:z-10 focus:z-10 -ml-px -mt-px"
            slug={entry.slug}
            author={entry.author}
